const cardsData = [
    [{ value: '1', suit: 'checkmark' }, { value: '2', suit: 'checkmark' }, { value: '3', suit: 'checkmark' }, { value: '4', suit: 'checkmark' }, { value: '8', suit: 'checkmark' }],
    [{ value: '5', suit: 'checkmark' }, { value: '6', suit: 'checkmark' }, { value: '7', suit: 'checkmark' }, { value: '8', suit: 'checkmark' }, { value: '7', suit: 'hearts' }],
    [{ value: '9', suit: 'checkmark' }, { value: '10', suit: 'checkmark' }, { value: 'J', suit: 'clubs' }, { value: 'Q', suit: 'clubs' }, { value: '6', suit: 'checkmark' }],
    [{ value: 'K', suit: 'checkmark' }, { value: '1', suit: 'checkmark' }, { value: '2', suit: 'checkmark' }, { value: '3', suit: 'checkmark' }, { value: '5', suit: 'checkmark' }],
    [{ value: '4', suit: 'checkmark' }, { value: '5', suit: 'checkmark' }, { value: '6', suit: 'checkmark' }, { value: '7', suit: 'checkmark' }, { value: '9', suit: 'spades' }],
...
function showModal() {
    ...
    modal.innerHTML = `
        <div class="modal-content">
            ...
            <button id="nextRoundButton">Finish</button>
        </div>
    `;
    ...
    document.getElementById('nextRoundButton').addEventListener('click', () => {
        ...
        setTimeout(() => {
            ...
            window.location.href = `/thankyou/index.html?uniqueId=${uniqueId}`;
