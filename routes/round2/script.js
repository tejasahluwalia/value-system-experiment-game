...
const cardsData = [
    [{ value: '2', suit: 'checkmark' }, { value: '3', suit: 'checkmark' }],
    [{ value: '6', suit: 'checkmark' }, { value: '7', suit: 'checkmark' }],
    [{ value: '10', suit: 'checkmark' }, { value: 'J', suit: 'clubs' }],
    [{ value: '1', suit: 'checkmark' }, { value: '2', suit: 'checkmark' }],
    [{ value: '5', suit: 'checkmark' }, { value: '6', suit: 'checkmark' }],
    [{ value: '9', suit: 'hearts' }, { value: '10', suit: 'checkmark' }]
];
